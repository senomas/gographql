...
func TestTodo(t *testing.T) {
	...
	t.Run("find books filter by title not and author_name not", func(t *testing.T) {
		if mock != nil {
			mock.ExpectQuery(QuoteMeta(`SELECT count(*) FROM "books" WHERE books.title NOT LIKE $1 AND books.id NOT IN (SELECT book_id FROM "authors" JOIN book_authors ON authors.id = book_authors.author_id WHERE authors.name = $2)`)).WithArgs("%Stone%", "Lord Voldermort").WillReturnRows(sqlmock.NewRows([]string{"count"}).
				AddRow(1))

			mock.ExpectQuery(QuoteMeta(`SELECT "books"."id","books"."title" FROM "books" WHERE books.title NOT LIKE $1 AND books.id NOT IN (SELECT book_id FROM "authors" JOIN book_authors ON authors.id = book_authors.author_id WHERE authors.name = $2) LIMIT 10`)).WithArgs("%Stone%", "Lord Voldermort").WillReturnRows(sqlmock.NewRows([]string{"id", "title"}).
				AddRow(2, "Harry Potter and the Chamber of Secrets"))

			mock.ExpectQuery(QuoteMeta(`SELECT "book_authors"."book_id","authors"."id","authors"."name" FROM "authors" JOIN book_authors ON authors.id = book_authors.author_id WHERE book_authors.book_id IN ($1)`)).WithArgs(2).WillReturnRows(sqlmock.NewRows([]string{"book_id", "id", "name"}).
				AddRow(2, 1, "J.K. Rowling"))
		}
		defer func() {
			if mock != nil {
	...
	t.Run("find books filter unknown author_name", func(t *testing.T) {
		if mock != nil {
			mock.ExpectQuery(QuoteMeta(`SELECT count(*) FROM "books" WHERE books.id IN (SELECT book_id FROM "authors" JOIN book_authors ON authors.id = book_authors.author_id WHERE authors.name = $1)`)).WithArgs("Harry Potter").WillReturnRows(sqlmock.NewRows([]string{"count"}).
				AddRow(0))
		}
		defer func() {
			if mock != nil {
	...
	t.Run("find books + reviews", func(t *testing.T) {
		if mock != nil {
			...
			mock.ExpectQuery(QuoteMeta(`SELECT "books"."id","books"."title" FROM "books" LIMIT 10`)).WithArgs(NoArgs...).WillReturnRows(sqlmock.NewRows([]string{"id", "title"}).
				...
				AddRow(3, "Harry Potter and the Book of Evil").
				AddRow(4, "Harry Potter and the Snake Dictionary"))
			mock.ExpectQuery(QuoteMeta(`SELECT "book_id","id","star","text" FROM "reviews" WHERE book_id IN ($1,$2,$3,$4)`)).WithArgs(reviewArgs, reviewArgs, reviewArgs, reviewArgs).WillReturnRows(sqlmock.NewRows([]string{"id", "book_id", "star", "text"}).
	...
	t.Run("find books + reviews filter by star", func(t *testing.T) {
		if mock != nil {
			...
			mock.ExpectQuery(QuoteMeta(`SELECT "books"."id","books"."title" FROM "books" LIMIT 10`)).WithArgs(NoArgs...).WillReturnRows(sqlmock.NewRows([]string{"id", "title"}).
				...
				AddRow(3, "Harry Potter and the Book of Evil").
				AddRow(4, "Harry Potter and the Snake Dictionary"))
			mock.ExpectQuery(QuoteMeta(`SELECT "book_id","id","star","text" FROM "reviews" WHERE book_id IN ($1,$2,$3,$4) AND "reviews"."star" >= $5`)).WithArgs(reviewArgs, reviewArgs, reviewArgs, reviewArgs, 3).WillReturnRows(sqlmock.NewRows([]string{"id", "book_id", "star", "text"}).
				AddRow(1, 1, 5, "The Boy Who Live").
				AddRow(2, 2, 5, "The Girl Who Kill").
				AddRow(4, 1, 3, "The Man With Funny Hat"))
		}
	...
	t.Run("find books filter by title and review.star", func(t *testing.T) {
		if mock != nil {
			mock.ExpectQuery(QuoteMeta(`SELECT DISTINCT "books"."id","books"."title" FROM "books" JOIN reviews ON books.id = reviews.book_id WHERE books.title LIKE $1 AND "reviews"."star" >= $2 LIMIT 10`)).WithArgs("%Harry Potter%", 3).WillReturnRows(sqlmock.NewRows([]string{"id", "title"}).
				AddRow(1, "Harry Potter and the Sorcerer's Stone").
				AddRow(2, "Harry Potter and the Chamber of Secrets"))
		}
		defer func() {
	...
	t.Run("create review", func(t *testing.T) {
		if mock != nil {
			...
			mock.ExpectQuery(QuoteMeta(`SELECT "book_authors"."book_id","authors"."id","authors"."name" FROM "authors" JOIN book_authors ON authors.id = book_authors.author_id WHERE book_authors.book_id IN ($1)`)).WithArgs(3).WillReturnRows(sqlmock.NewRows([]string{"book_id", "id", "name"}).
				AddRow(3, 2, "Lord Voldermort"))
		}
		defer func() {
			if mock != nil {
	...
	t.Run("create book", func(t *testing.T) {
		if mock != nil {
			...
			mock.ExpectQuery(QuoteMeta(`SELECT "book_authors"."book_id","authors"."id","authors"."name" FROM "authors" JOIN book_authors ON authors.id = book_authors.author_id WHERE book_authors.book_id IN ($1)`)).WithArgs(5).WillReturnRows(sqlmock.NewRows([]string{"book_id", "id", "name"}).
	...
	t.Run("update book", func(t *testing.T) {
		if mock != nil {
			...
			mock.ExpectQuery(QuoteMeta(`SELECT "book_authors"."book_id","authors"."id","authors"."name" FROM "authors" JOIN book_authors ON authors.id = book_authors.author_id WHERE book_authors.book_id IN ($1)`)).WithArgs(4).WillReturnRows(sqlmock.NewRows([]string{"book_id", "id", "name"}).
				AddRow(4, 3, "Salazar Slitherin").
	...
	t.Run("find updated books", func(t *testing.T) {
		if mock != nil {
			...
			mock.ExpectQuery(QuoteMeta(`SELECT "book_authors"."book_id","authors"."id","authors"."name" FROM "authors" JOIN book_authors ON authors.id = book_authors.author_id WHERE book_authors.book_id IN ($1,$2,$3,$4,$5)`)).WithArgs(args, args, args, args, args).WillReturnRows(sqlmock.NewRows([]string{"book_id", "id", "name"}).
				AddRow(1, 1, "J.K. Rowling").
				AddRow(2, 1, "J.K. Rowling").
				AddRow(3, 2, "Lord Voldermort").
				AddRow(4, 3, "Salazar Slitherin").
	...
	t.Run("find deleted books", func(t *testing.T) {
		if mock != nil {
			...
			mock.ExpectQuery(QuoteMeta(`SELECT "book_authors"."book_id","authors"."id","authors"."name" FROM "authors" JOIN book_authors ON authors.id = book_authors.author_id WHERE book_authors.book_id IN ($1,$2,$3,$4)`)).WithArgs(args, args, args, args).WillReturnRows(sqlmock.NewRows([]string{"book_id", "id", "name"}).
				AddRow(1, 1, "J.K. Rowling").
				AddRow(2, 1, "J.K. Rowling").
				AddRow(3, 2, "Lord Voldermort").
				AddRow(5, 1, "J.K. Rowling").
