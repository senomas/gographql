...
func AuthorMutations(db *sql.DB, fields graphql.Fields) graphql.Fields {
	fields["createAuthor"] = &graphql.Field{
		...
		Resolve: CreateAuthorResolver(db),
	}
	fields["updateAuthor"] = &graphql.Field{
		...
		Resolve: UpdateAuthorResolver(db),
	}
	return fields
}

func CreateAuthorResolver(db *sql.DB) func(p graphql.ResolveParams) (interface{}, error) {
...
func UpdateAuthorResolver(db *sql.DB) func(p graphql.ResolveParams) (interface{}, error) {
	return func(p graphql.ResolveParams) (interface{}, error) {
		var params []interface{}
